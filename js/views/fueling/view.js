                ...
                <div id="fuel-help-modal" class="hidden fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
                    <div class="bg-slate-900 border border-slate-700 rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto custom-scrollbar shadow-2xl">
                        ...
                        <div class="p-4 space-y-6 text-sm text-slate-300">
                            ...
                            <div>
                                <h4 class="text-emerald-400 font-bold uppercase text-xs mb-2">1. Visual Inventory (Bottles)</h4>
                                <p class="mb-2">The two bottles show what is physically logged.</p>
                                <ul class="list-disc pl-4 space-y-1 text-xs text-slate-400">
                                    <li><span class="text-blue-400 font-bold">Mix Bottle:</span> Tracks your Carbs + Fluid. Log 4 sips to finish a bottle.</li>
                                    <li><span class="text-cyan-400 font-bold">Water Bottle:</span> Tracks Fluid only. Use this when drinking plain water.</li>
                                    <li>If your physical bottle is empty but the screen shows liquid, you forgot to log a sip!</li>
                                </ul>
                            </div>

                            <div>
                                <h4 class="text-emerald-400 font-bold uppercase text-xs mb-2">2. Pacing (Progress Bars)</h4>
                                <p class="mb-2">The horizontal bars track your overall ride goals.</p>
                                <ul class="list-disc pl-4 space-y-1 text-xs text-slate-400">
                                    <li><span class="font-bold text-white">Colored Bar:</span> Amount consumed so far.</li>
                                    <li><span class="font-bold text-white">White Line:</span> Where you *should* be right now based on ride time.</li>
                                    <li>If the bar is behind the white line, you are under-fueling. Catch up!</li>
                                </ul>
                            </div>

                            <div>
                                <h4 class="text-emerald-400 font-bold uppercase text-xs mb-2">3. Controls</h4>
                                <ul class="list-disc pl-4 space-y-1 text-xs text-slate-400">
                                    <li><span class="text-blue-400 font-bold">MIX SIP:</span> Adds Fluid AND Carbs (resets drink timer).</li>
                                    <li><span class="text-cyan-400 font-bold">WATER SIP:</span> Adds Fluid ONLY (resets drink timer).</li>
                                    <li><span class="text-orange-400 font-bold">FOOD:</span> Log solid food items to add carbs (resets eat timer).</li>
                                </ul>
                            </div>

                            <div class="bg-slate-800 p-3 rounded text-[10px] text-slate-400 italic">
                                <strong>Auto-Save:</strong> The app saves your progress every second. If you close the tab or your phone dies, the session resumes exactly where you left off.
                            </div>
                        </div>
