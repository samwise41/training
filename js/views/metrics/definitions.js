...
export const METRIC_DEFINITIONS = {
    // --- CYCLING (Purple) ---
    subjective_bike: {
        title: "Bike RPE Efficiency", sport: "Bike", icon: "fa-person-biking", colorVar: "#a855f7",
    ...
    endurance: {
        title: "Aerobic Efficiency", sport: "Bike", icon: "fa-heart-pulse", colorVar: "#a855f7",
    ...
    strength: {
        title: "Torque Efficiency", sport: "Bike", icon: "fa-bolt", colorVar: "#a855f7",
    ...
    // --- RUNNING (Pink) ---
    subjective_run: {
        title: "Run RPE Efficiency", sport: "Run", icon: "fa-person-running", colorVar: "#ec4899",
    ...
    run: {
        title: "Running Economy", sport: "Run", icon: "fa-gauge-high", colorVar: "#ec4899",
    ...
    mechanical: {
        title: "Mechanical Stiffness", sport: "Run", icon: "fa-ruler-horizontal", colorVar: "#ec4899",
    ...
    gct: {
        title: "Ground Contact Time", sport: "Run", icon: "fa-stopwatch", colorVar: "#ec4899",
    ...
    vert: {
        title: "Vertical Oscillation", sport: "Run", icon: "fa-arrows-up-down", colorVar: "#ec4899",
    ...
    // --- SWIMMING (Blue) ---
    subjective_swim: {
        title: "Swim RPE Efficiency", sport: "Swim", icon: "fa-person-swimming", colorVar: "#3b82f6",
    ...
    swim: {
        title: "Swim Efficiency", sport: "Swim", icon: "fa-person-swimming", colorVar: "#3b82f6",
    ...
    // --- GENERAL (Emerald) ---
    vo2max: {
        title: "VO₂ Max Trend", sport: "All", icon: "fa-lungs", colorVar: "#10b981",
    ...
    tss: {
        title: "Weekly TSS Load", sport: "All", icon: "fa-layer-group", colorVar: "#10b981",
    ...
    anaerobic: {
        title: "Anaerobic Impact", sport: "All", icon: "fa-fire", colorVar: "#10b981",
