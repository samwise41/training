...
(async function initApp() {
    ...
    const App = {
        ...
        // Helper to get stats bar (Only used for trends now, not dashboard)
        getStatsBar() {
            ...
            setTimeout(() => {
                ...
                try {
                    if (view === 'trends') {
                        ...
                        // DASHBOARD VIEW
                        // Removed this.getStatsBar() so it renders cleaner
                        const html = renderDashboard(this.plannedData, this.allData, this.planMd);
