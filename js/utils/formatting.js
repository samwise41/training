...
export const Formatters = {
    ...
    WEATHER: { 0: ["Clear", "☀️"], 1: ["Partly Cloudy", "🌤️"], 2: ["Partly Cloudy", "🌤️"], 3: ["Cloudy", "☁️"], 45: ["Foggy", "🌫️"], 48: ["Foggy", "🌫️"], 51: ["Drizzle", "🌦️"], 61: ["Rain", "🌧️"], 63: ["Rain", "🌧️"], 71: ["Snow", "❄️"], 95: ["Storm", "⛈️"] },
    getWeatherInfo(code) { return this.WEATHER[code] || ["Unknown", "qm"]; },
    parseDuration(val) {
        ...
        if (str.includes('h')) {
            ...
            if (parts[1] && parts[1].includes('m')) mins += parseInt(parts[1].replace('m',''));
